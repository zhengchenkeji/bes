 ...
 */
public interface BranchContemporaneousMapper {
    ...
    List<Map<String,Object>> queryData(@Param("branchId") String branchId,@Param("thisTime") String thisTime,@Param("lastTime") String lastTime);
}