...
import com.zc.efounder.JEnterprise.mapper.energyAnalysis.BranchRingRatioMapper;
...
/**
 * @Description 支路环比Service业务层处理
 *
 * @author liuwenge
 * @date 2022/11/9 10:48
 */
@Service
public class BranchRingRatioServiceImpl implements BranchRingRatioService {

    @Resource
    private BranchRingRatioMapper branchRingRatioMapper;
    @Resource
    ...
    public List<Park> getAllPark(){
        return branchRingRatioMapper.getAllPark();
    }
     ...
     */
    @Override
    public AjaxResult queryData(String branchId,String dateType,String thisTime){
        if (!StringUtils.hasText(branchId) || !StringUtils.hasText(dateType) || !StringUtils.hasText(thisTime)){
        ...
        if (dateType.equals("1")){
            ...
            dataList = branchRingRatioMapper.queryDayData(branchId,thisTime,lastTime);
            ...
            lastTime = dateFormat.format(calendar.getTime());
            dataList = branchRingRatioMapper.queryMonthData(branchId,thisTime,lastTime);
