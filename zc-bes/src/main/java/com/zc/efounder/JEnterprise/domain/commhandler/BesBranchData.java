 ...
 * @date 2018-08-03
 */
public class BesBranchData extends BaseEntity {
    /**
     *
     */
    ...
    public String getfAccurateCjsj() {
        return fAccurateCjsj;
    }

    public void setfAccurateCjsj(String fAccurateCjsj) {
        this.fAccurateCjsj = fAccurateCjsj;
    }
