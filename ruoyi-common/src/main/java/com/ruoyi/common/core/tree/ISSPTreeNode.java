...
public class ISSPTreeNode implements Serializable {
	 ...
	 *
	 */
	private Set<String> fZlbhBeLinkedAmmeter;
	...
	public Set<String> getfZlbhBeLinkedAmmeter() {
		return fZlbhBeLinkedAmmeter;
	}

	public void setfZlbhBeLinkedAmmeter(Set<String> fZlbhBeLinkedAmmeter) {
		this.fZlbhBeLinkedAmmeter = fZlbhBeLinkedAmmeter;
	}
}