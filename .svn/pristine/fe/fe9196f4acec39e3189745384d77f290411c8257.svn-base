 ...
 * @Author: wanghongjie
 * @Description:
 * @Date: Created in 9:29 2023/2/10
 * @Modified By:
 */
...
//测试get方法
//        String s = HttpClientUtil2.doGet("http://111.14.222.51:9001//energy/issp/v1.0/login");
//        System.out.println("get方法:"+s);
        ...
        String postString = HttpClientUtil2.doPost("http://111.14.222.51:9001//energy/issp/v1.0/login",s1);
