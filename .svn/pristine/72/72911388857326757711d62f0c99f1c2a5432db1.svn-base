...
<script>
  import { getDeviceTreee,listDevicejob,addDevicejob,updateJob,getPointList,getDeviceJob,getChcekNodes,delDeviceJob,changeJobStatus,runJob } from "@/api/monitor/deivceJob";
  ...
  export default {
    ...
    data() {
      return {
        ...
        queryParams: {
          ...
          pageSize: 10,
          jobName: undefined,
          jobGroup:JobSettings.deviceJob,
          status: undefined,
          remark: ""
        },
    ...
    methods: {
      ...
      handleJobLog(row) {
        ...
        const jobGroup=JobSettings.deviceJob;
      ...
      submitForm: function() {
        ...
        this.$set(this.form,'jobGroup',JobSettings.deviceJob);
