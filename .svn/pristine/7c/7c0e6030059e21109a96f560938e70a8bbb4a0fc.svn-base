package com.zc.connect.nettyClient.service.Impl;
 ...
 * @Author: wanghongjie
 * @Description:
 * @Date: Created in 14:25 2023/3/14
 * @Modified By:
 */
@Service
public class NettyClientServiceImpl implements NettyClientService {
    ...
    public String sendSyncMsg(String text, String dataId, String serviceId) {
        ...
        // 发送同步消息
        String result = sendSyncMsgHandler.sendSyncMsg(object.toJSONString(),"127.0.0.1", 9002, syncFuture);
