  ...
  export default {
    ...
    watch: {
      ...
      treeNodeMsgs(value) {//右侧设备数据展示
        //查询能源类型
        if(value.treeId != null &&(value.nodeType==deviceTreeSettings.DI
          || value.nodeType==deviceTreeSettings.AI
          || value.nodeType==deviceTreeSettings.AO
          || value.nodeType==deviceTreeSettings.DO
          || value.nodeType==deviceTreeSettings.Vpoint) ){
      ...
      besPoint_websocket(data) {
        ...
        if(this.underFormData.initValue == null || this.underFormData.initValue == undefined){
    ...
    methods: {
      ...
      dataComparison(nodeTypeValue) {
        ...
        if (nodeTypeValue == deviceTreeSettings.Vpoint) {//虚点
          ...
          //初始值是否为null
          if(pointData.initVal == null || pointData.initVal == undefined){
            pointData.initVal = 0
          }
          //根据精度运算
