<template>
  ...
  >
    ...
    <Shape
      ...
      :styles="getComponentStyle(item.style)"
    >
      <component
        :is="item.component"
...
<script>
  ...
  import { getStyle, getComponentRotatedStyle, getShapeStyle, getSVGStyle, getCanvasStyle } from '@/utils/designer/style'
  ...
  export default {
    ...
    beforeDestroy() {
      console.log("设计器页面销毁了")
      this.$store.commit('setIsUnsubscribe', false);
    },
    methods: {
      getDeviceTree(){
