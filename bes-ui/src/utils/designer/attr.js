export const styleData = [
    ...
    { key: 'booFlow', label: '线条是否流动' },
    { key: 'linePointColor', label: '滚动颜色' },
]
...
export const selectKey = ['textAlign', 'borderStyle', 'verticalAlign', 'booFlow']

export const optionMap = {
    textAlign: textAlignOptions,
    borderStyle: borderStyleOptions,
    verticalAlign: verticalAlignOptions,
    booFlow: booFlowOptions
}
