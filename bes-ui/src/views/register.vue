...
<script>
import { getCaptchaConfig, getCodeImg, register } from '@/api/login'
  ...
  methods: {
    ...
    registerRequest() {
      register(this.registerForm).then(res => {
        ...
        this.$alert(`<span style="color: red; ">恭喜你，您的账号${username}注册成功！</span>`, '系统提示', {
    ...
    captchaCheckSuccess(params) {
      ...
      this.registerForm.code = params.captchaVerification;
      this.loading = true;
      this.registerRequest();
    },
  }
